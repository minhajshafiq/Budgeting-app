...
class SessionService {
  ...
  Future<bool> _validateTokens(String accessToken, String refreshToken) async {
    try {
      // TODO: Implémenter la validation des tokens avec la nouvelle architecture
      // Pour l'instant, on considère que les tokens sont valides
      // Cette logique devra être adaptée pour utiliser le nouveau système d'authentification
      debugPrint('⚠️ Token validation: À implémenter avec la nouvelle architecture');
        return true;
    } catch (e) {
